...
<div class='newPost-holder'>
    ...
    <div class='newPost-body'>
        <form action='' onclick='return false;'>
            <fieldset>
                ...
                <input type='text' placeholder='Enter post title' id='newPost-title'>
            </fieldset>

            <fieldset>
                <legend>author:</legend>
                <input type='text' placeholder='Enter post author' id='newPost-author'>
            </fieldset>
            
            <fieldset>
                <legend>post text:</legend>
                <textarea rows='10' cols='45' name='text' placeholder='Enter post text'  id='newPost-text'></textarea>
            </fieldset>
            
            <fieldset>
                <legend>post image:</legend>
                <input type='text' placeholder='Choose post image'  id='newPost-photo'>
            </fieldset>
            
            <fieldset>
                <legend>ready?</legend>
                <button id='newPost-btn'>POST</button>
            </fieldset>
    ...
    function renderNewPost() {
        ...
        postHolder.id = 'newPost';
        VIEW.appendChild(postHolder);
        postHolder.innerHTML = createNewPost();
        document.getElementById('newPost-btn').onclick=poster;
        blog.Utils.isLoading(false, 'spinner');
    }
...
function poster(){
    console.log('Hello');
    var newpost={
        'title': document.getElementById('newPost-title').value,
        'author': document.getElementById('newPost-author').value,
        'text': document.getElementById('newPost-text').value,
        'photo': document.getElementById('newPost-photo').value    
    };
    console.log(newpost);
    var params = {
            method: "POST",
